...
aws_access_key_id = 'AKIAZPBE4QB4JZBIVUIE'
aws_secret_access_key = '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'
...
TaskAttributes = {
    ...
    'Reward': '5.00',
    'Title': '(Round 2) Choose the image that shows better behavior',
    'Keywords': 'trajectory',
